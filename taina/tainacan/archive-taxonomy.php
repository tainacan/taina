<?php
    ...
    $faceted_search_block = do_blocks('<!-- wp:tainacan/faceted-search {"termId":"' . $wordpress_term->term_id . '","taxonomyId":"' . $wordpress_term->taxonomy . '","listType":"taxonomy"} -->
