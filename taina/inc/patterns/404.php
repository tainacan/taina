...
return array(
    ...
    'viewportWidth' => 1400,
    'inserter'      => false,
    'content'       => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"20vh","bottom":"20vh"}}},"layout":{"inherit":true}} -->
                        <div class="wp-block-group alignfull" style="padding-top:20vh;padding-bottom:20vh">
                            <!-- wp:cover {"dimRatio":20,"minHeight":13,"minHeightUnit":"em","contentPosition":"center center","isDark":false,"align":"full","className":"is-style-taina-cover-title-as-background","style":{"spacing":{"padding":{"top":"42px","right":"0px","bottom":"42px","left":"0px"}}}} -->
                            <div class="wp-block-cover alignfull is-light is-style-taina-cover-title-as-background" style="padding-top:42px;padding-right:0px;padding-bottom:42px;padding-left:0px;min-height:13em"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-20 has-background-dim"></span>
